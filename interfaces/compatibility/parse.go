...
//
// Expr ::= Atom ExprR
// ExprR ::= OrExprR | AndExprR | eps
// OrExprR ::= 'OR' Atom OrExprROpt
// OrExprROpt ::= OrExprR | eps
// AndExprR ::= 'AND' Atom AndExprROpt
// AndExprROpt ::= AndExprR | eps
// Atom ::= '(' Expr ')' | Label
//
...
//              First         Follow
// Expr         '(',Label     EOF,')'
// ExprR        'OR','AND',eps  EOF,')'
// OrExprR      'OR'          EOF,')'
// OrExprROpt   'OR',eps        EOF,')'
// AndExprR     'AND'         EOF,')'
// AndExprROpt  'AND',eps       EOF,')'
...
// calling Expr. FIRST is used to decide the next method to take. If eps is in
